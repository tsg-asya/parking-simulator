...
@InputType()
class ReservationCreateNestedManyWithoutParkingSpacesInput {
...
export { ReservationCreateNestedManyWithoutParkingSpacesInput as ReservationCreateNestedManyWithoutParkingSpacesInput };
