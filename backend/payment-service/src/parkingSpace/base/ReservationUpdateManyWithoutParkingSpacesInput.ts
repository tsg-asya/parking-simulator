...
@InputType()
class ReservationUpdateManyWithoutParkingSpacesInput {
...
export { ReservationUpdateManyWithoutParkingSpacesInput as ReservationUpdateManyWithoutParkingSpacesInput };
